...
module.exports = function(grunt) {
  ...
  const sdkEntry = 'public/js/sdk/export.js';
  const sdkOutput = 'public/js/owt.js';

  var srcFiles = [
    'public/js/sdk/base/**',
    'public/js/sdk/p2p/**',
    'public/js/sdk/conference/**'
  ];

  var restFiles = [
    'public/js/sdk/rest/hmac-sha256.js',
    'public/js/sdk/rest/Base64.js',
    'public/js/sdk/rest/API.js'
  ];
...
window.L = L;\n\
    ...
    eslint: {
      options: {
        configFile: 'public/js/.eslintrc.json'
      },
      src: srcFiles
    },
    browserify: {
